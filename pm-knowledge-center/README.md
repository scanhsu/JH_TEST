...
>
> 本庫以 **PLM 為主體**：內容聚焦產品架構設計、平台選型、成本與 roadmap 等 PLM 核心工作。**PLM 就是產品架構師（Product Architect）** —— 產品的系統架構由 PLM 主導設計，RD 負責底層實作。**PJM（專案經理）與 RD（研發）是我們的合作對象**，相關流程說明皆以「PLM 如何與其協作」的角度整理。
